...
def calculate_profitability_percentage(monthly_rent: float, rental_vacancies: float, expenses: float, 
    ...
    Args:
        ...
        rental_vacancies (float): The vacancy rate (e.g., 0.1 for 10% vacancy).
        expenses (float): The total expenses related to the property (maintenance, taxes, etc.).
        property_value (float): The market value of the property.
        property_work (float): The cost of any work or renovations done to the property.
        contribution (float): The down payment or initial contribution made by the owner.
...
def calculate_loan_cost(total_property_loan: float, bank_interest_rate: float, loan_duration_years: float, 
    ...
    This function computes the monthly payment (installment), the total cost of the loan over the specified duration,
    ...
    Args:
        total_property_loan (float): The total amount of the loan taken for the property (principal).
    ...
    Note:
        ...
        - The result gives the total loan cost over the entire period and the real cost of the loan (excluding the original principal).
    """
...
def calculate_cashflow_pretax(monthly_rent: float, monthly_payment: float, expenses: float) -> float:
    ...
    Args:
        monthly_rent (float): The monthly rent income generated by the property.
        monthly_payment (float): The monthly payment for the property loan or any other financial obligations.
