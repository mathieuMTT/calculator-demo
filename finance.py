...
from utils import get_percentage_increment
...
class Property:
    ...
    Attributes:
        agency_fees_rate (float): The percentage rate of the agency fees applied to the property purchase price.
        notary_fees_rate (float): The percentage rate of notary fees calculated based on the property purchase price, including agency fees.
        price (float): The purchase price of the property without notary and agency fees.
        work_cost (float): The cost of work or renovations on the property.
        square (float): The total square meter of the property.
    ...
    def get_property_price_with_agency_fees(self) -> tuple[float, float]:
        """
        Calculate the total price of the property with agency fees and the increment due to agency fees.

        Returns:
            tuple[float, float]: A tuple containing:
                - The total price of the property including agency fees.
                - The increment added by the agency fees.
        """
        agency_fees_increment = self.price * (self.agency_fees_rate / 100)
    ...
    def get_property_price_with_notary_fees(self) -> tuple[float, float]:
        ...
        Returns:
            tuple[float, float]: A tuple containing:
                - The total price of the property including notary fees.
    ...
    def get_price_per_square_meter(self) -> float:
        ...
        Returns:
            float: The total property price per square meter.
        """
        property_price_with_agency_fees, _ = self.get_property_price_with_agency_fees()
...
class Loan:
    ...
    def total_cost(self) -> float:
        ...
        n = self.duration_years * 12
        return self.get_loan_insurance_monthly_payment() * n
    ...
    def calculate_loan_and_expenses(
        self, monthly_payment: float, expenses: float
    ) -> float:
        """
